...
combinations <- data.frame(
  ...
  SlideNumber = c("s01", "s02", "s03", "s04", "s05", "s06", "s07", "s08", "s09", "s10", "s11", "s12")
)
...
colorbycluster <- data_frame_final %>% 
  filter(BrainRegion=="HYPO", MouseID=="MR161", SlideNumber=="s09") %>% dplyr::select(c(Cluster, ID))
write.csv(colorbycluster, "/Users/alexlawson/Masters-Data-Final/Representative-images/Ciernia Lab/Hypothalamus/dapionly/v8/csv/HYPO_MR61_CON_F_s09.csv")
